...
$result= mysql_query("SELECT * FROM pasien ORDER BY kd_pasien ASC") or die(mysql_error());
echo mysql_error();
...
class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Ln();
            $this->Cell(279,10,'Report Data Pasien','TBLR',0,'C'); //TBLR (untuk garis)=> B = Bottom,
            // L = Left, R = Right
    ...
    $pdf->Cell(25,10,'Kode Pasien','LRTB',0,'C');
    $pdf->Cell(32,10,'Nama Pasien','LRTB',0,'C');
    $pdf->Cell(70,10,'Alamat','LRTB',0,'C');
